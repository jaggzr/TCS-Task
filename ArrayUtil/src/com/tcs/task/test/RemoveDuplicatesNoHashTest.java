 ...
 * @author Jagadeesan
 * 
 *         Class <code>RemoveDuplicatesNoHashTest</code> provides Junit test
 *         case to check if removeDuplicatesNoHash method removes duplicates
...
public class RemoveDuplicatesNoHashTest {
     ...
     *
     */
    private Integer[] randomIntegers = { 1, 2, 34, 34, 25, 1, 45, 3, 26, 85, 4, 34, 86, 25, 43, 2, 1, 10000, 11, 16, 19,
     ...
     * 
     * @return Integer[] An array of Integers.
     */
    ...
    public void testRemoveDuplicatesNoHash() {
        Integer[] sortedArray = CheckDuplicate.getInstance().findAndRemoveDuplicates(getRandomIntegers(),
    ...
    public void throwsRuntimeExceptionWhenNull() {
        Integer[] sortedArray = CheckDuplicate.getInstance().findAndRemoveDuplicates(null, AlgoConstants.ALGO_NO_HASH);
    }
}
